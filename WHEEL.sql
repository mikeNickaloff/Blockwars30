...
INSERT INTO defs VALUES(339,51,'member','gridHeight','Computed grid height from rows, cell height, and vertical gaps for spawn offsets.','readonly property int gridHeight: (gridRows * cellH) + Math.max(0, gridRows - 1) * gapY');
INSERT INTO defs VALUES(340,51,'function','row, column','Returns the block entry item at the requested grid coordinates or null when empty or out of range.','getBlockEntryAt(row, column)');
INSERT INTO defs VALUES(344,51,'function','None','Placeholder hook for populating the blocks model; actual entries supplied elsewhere after revert.','fillGrid()');
INSERT INTO defs VALUES(345,51,'function','row, column','Returns the GameDragItem delegate at the specified grid coordinates or null when unavailable.','getBlockWrapper(row, column)');
...
INSERT INTO defs VALUES(352,51,'function','row, column','Calculates the linear model index for a given row and column in the grid.','indexFor(row, column)');
INSERT INTO defs VALUES(353,51,'function','blockId','Searches the ListModel for an entry matching the provided block identifier.','findModelIndexByItemName(blockId)');
INSERT INTO defs VALUES(354,51,'function','blockId','Returns the GameDragItem wrapper whose entry carries the requested block identifier.','findWrapperByItemName(blockId)');
...
INSERT INTO defs VALUES(363,51,'member','stateHelper','Helper object exposing the current state and hooks into the BattleGridStateMachine for evaluation.','readonly property var stateHelper: ({');
INSERT INTO defs VALUES(364,51,'member','blocksModel','FIFO collection of pending BattleGrid queue events.','property alias blocksModel: blocksModel');
...
INSERT INTO defs VALUES(367,51,'member','activeQueuePromise','Active Lib.Promise instance awaiting queue completion.','property QtObject activeQueuePromise: null');
INSERT INTO defs VALUES(368,51,'signal','fromState, toState, metadata','Emitted just before the current state changes.','signal stateTransitionStarted(string fromState, string toState, var metadata)');
INSERT INTO defs VALUES(369,51,'signal','fromState, toState, metadata','Emitted after the state has been updated.','signal stateTransitionFinished(string fromState, string toState, var metadata)');
INSERT INTO defs VALUES(370,51,'signal','requestedState, reason, metadata','Sent when setState is asked to use an invalid or blocked state.','signal stateTransitionRejected(string requestedState, string reason, var metadata)');
INSERT INTO defs VALUES(371,51,'signal','item','Fires when a queue entry begins processing.','signal queueItemStarted(var item)');
INSERT INTO defs VALUES(372,51,'signal','item, context','Fires when the active queue entry signals completion.','signal queueItemCompleted(var item, var context)');
INSERT INTO defs VALUES(373,51,'function','value','Normalizes state tokens by trimming and lower-casing user input.','normalizeStateName(value)');
INSERT INTO defs VALUES(374,51,'function','value','Checks whether a requested state is part of the supported list.','isValidState(value)');
INSERT INTO defs VALUES(375,51,'function','nextState, metadata','Transitions the grid to a new state while emitting change notifications and honoring the queue guard.','setState(nextState, metadata)');
INSERT INTO defs VALUES(376,51,'function','targetState, metadata','Ensures the requested state is active, delegating to setState only when it differs.','ensureState(targetState, metadata)');
INSERT INTO defs VALUES(377,51,'function','None','Creates a new Lib.Promise tied to queue completion events.','initializeQueuePromise()');
INSERT INTO defs VALUES(378,51,'function','None','Disconnects and destroys the active queue promise instance.','disposeQueuePromise()');
INSERT INTO defs VALUES(379,51,'function','None','Restarts the queue timer once the current promise resolves.','handleQueuePromiseFulfilled()');
INSERT INTO defs VALUES(380,51,'function','context','Convenience wrapper that emits queueItemCompleted with the active item.','finishActiveQueueItem(context)');
INSERT INTO defs VALUES(381,51,'function','eventObject','Adds a new event to the queue and starts processing if idle, enabling state machine driven transitions.','enqueueBattleEvent(eventObject)');
INSERT INTO defs VALUES(382,51,'function','None','Dequeues the next item, wires the promise callbacks, and executes start/main/end hooks safely.','processNextQueueItem()');
